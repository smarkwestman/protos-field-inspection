...
function App() {
  ...
  return <div className="app"><main ref={reportRef} className="report"><header className="header"><div className="logo"><img src="/protos-shield.png" alt="Protos Shield" style={{width:'48px',height:'48px'}} /></div><div><h1>Field Operations Inspection Report</h1><p>Protos Security: Operations</p></div><ScoreBadge label="Overall" value={overall}/></header>
