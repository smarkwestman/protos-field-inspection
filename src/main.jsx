...
async function generatePdf(email=false) {
  ...
  // Visit Info
  sectionBox('Visit Information', 1.25);
  ...
  if (officerPhoto[0]) {
    ...
    pdf.addImage(img, 'JPEG', 6.35, y - 0.35, 1.45, 1.35, undefined, 'FAST', 270);
  }
  ...
  textLine('Case Filed in Salesforce:', caseFiled ? 'Yes' : 'No', margin + 3.2, y + 0.55);
